var monjiImages = [
    ...
    {en:"monji-of-taiwan-3-1", md:"台灣三號之一", version:"3.1", is_main:true, level:1, parent:null, title_en:"Taiwan", title_md:"台灣", desc:"台字祥紋象徵天地和諧、吉祥平安，象徵台灣人的共榮團圓。", desc_inherit:false, tags:"taiwan", tags_inherit:false},
    ...
    {en:"monji-of-kaohsiung-city-4-8-2", md:"高雄市四號之八", version:"4.8.2", is_main:true, level:1, parent:null, title_en:"Kaohsiung City", title_md:"高雄市", desc:"紋結合了「高」字與<a src='/images/monjis/monji-of-takao-city.png' class='modal-trigger-image text-dark'>日本時代的高雄市章<i class='tbk tbk-takao mx-1'></i></a>，象徵高雄的歷史人文。<br><br>紋自上而下可分為三個菱形區塊，分別代表和平、民主與自由。", desc_inherit:false, tags:"kaohsiung", tags_inherit:false},
    ...
    {en:"monji-of-khh-cianjhen-5-1", md:"前鎮區五號之一", version:"5.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Cianjhen Dictrict", title_md:"前鎮區", desc:"「鎮」的台語羅馬拼音「tìn」的圖案化設計。", desc_inherit:false, tags:"kaohsiung,cianjhen", tags_inherit:false},
    {en:"monji-of-khh-cianjhen-6-1", md:"前鎮區六號之一", version:"6.1", is_main:false, level:2, parent:"monji-of-khh-cianjhen-5-1", title_en:"Cianjhen Dictrict", title_md:"前鎮區", desc:"「鎮」的台語羅馬拼音「tìn」的圖案化設計。", desc_inherit:false, tags:"", tags_inherit:true},
    ...
    {en:"monji-of-khh-ciaotou-2-1", md:"橋頭區二號之一", version:"2.1", is_main:false, level:2, parent:"monji-of-khh-ciaotou-2-2", title_en:"Ciaotou Dictrict", title_md:"橋頭區", desc:"「橋仔頭」的兩個台語羅馬拼音首字「K」和「T」的圖案化設計。", desc_inherit:false, tags:"", tags_inherit:true},
    {en:"monji-of-khh-ciaotou-2-2", md:"橋頭區二號之二", version:"2.2", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Ciaotou Dictrict", title_md:"橋頭區", desc:"「橋」的台語羅馬拼音首字「K」的圖案化設計。", desc_inherit:false, tags:"kaohsiung,ciaotou", tags_inherit:false},
    ...
    {en:"monji-of-khh-dashe-3-1", md:"大社區三號之一", version:"3.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Dashe Dictrict", title_md:"大社區", desc:"「社」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,dashe", tags_inherit:false},
    {en:"monji-of-khh-dashe-3-2", md:"大社區三號之二", version:"3.2", is_main:false, level:2, parent:"monji-of-khh-dashe-3-1", title_en:"Dashe Dictrict", title_md:"大社區", desc:"「社」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,dashe", tags_inherit:false},
    ...
    {en:"monji-of-khh-gangshan-2-1", md:"岡山區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Ganshan Dictrict", title_md:"岡山區", desc:"「岡」字的圖案化設計。", desc_inherit:false, tags:"", tags_inherit:true},
    {en:"monji-of-khh-gushan-2-1", md:"鼓山區二號之一", version:"2.1", is_main:false, level:2, parent:"monji-of-khh-gushan-3-1", title_en:"Gushan Dictrict", title_md:"鼓山區", desc:"「山」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,gushan", tags_inherit:false},
    {en:"monji-of-khh-gushan-3-1", md:"鼓山區三號之一", version:"3.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Gushan Dictrict", title_md:"鼓山區", desc:"「鼓」的注音「ㄍㄨˇ」<span class='text-secondary'>（省略聲調符號）</span>的圖案化設計。<br><br>線條描繪出的魚與山，象徵高雄港的山水風光。", desc_inherit:false, tags:"kaohsiung,gushan", tags_inherit:false},
    {en:"monji-of-khh-hunei-3-2", md:"湖內區三號之二", version:"3.2", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Hunei Dictrict", title_md:"湖內區", desc:"「湖」的台語羅馬拼音「Ôo」的圖案化設計。", desc_inherit:false, tags:"kaohsiung,hunei", tags_inherit:false},
    ...
    {en:"monji-of-khh-lingya-2-1", md:"苓雅區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Lingya Dictrict", title_md:"苓雅區", desc:"「苓」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,lingya", tags_inherit:false},
    ...
    {en:"monji-of-khh-niaosong-2-1", md:"鳥松區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Niaosong Dictrict", title_md:"鳥松區", desc:"「松」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,niaosong", tags_inherit:false},
    ...
    {en:"monji-of-khh-qijin-2-1", md:"旗津區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Qijin Dictrict", title_md:"旗津區", desc:"「旗津」舊名「旗後」、「旗後」源自「旗後山」。取三名的台語羅馬拼音首字「K」並作成堅山形象的厚紋，象徵不離不棄的忠誠、象徵無法竄改的的旗津史。", desc_inherit:false, tags:"kaohsiung,qijin", tags_inherit:false},
    {en:"monji-of-khh-qishan-2-1", md:"旗山區二號之一", version:"2.1", is_main:false, level:2, parent:"monji-of-khh-qishan-2-3", title_en:"Qishan Dictrict", title_md:"旗山區", desc:"「旗」的台語羅馬拼音「Kî」的圖案化設計。", desc_inherit:false, tags:"kaohsiung,qishan", tags_inherit:false},
    {en:"monji-of-khh-qishan-2-2", md:"旗山區二號之二", version:"2.2", is_main:false, level:2, parent:"monji-of-khh-qishan-2-3", title_en:"Qishan Dictrict", title_md:"旗山區", desc:"「旗」的台語羅馬拼音「Kî」<span class='text-secondary'>（省略聲調符號）</span>的圖案化設計。", desc_inherit:false, tags:"kaohsiung,qishan", tags_inherit:false},
    {en:"monji-of-khh-qishan-2-3", md:"旗山區二號之三", version:"2.3", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Qishan Dictrict", title_md:"旗山區", desc:"「旗」的台語羅馬拼音「Kî」<span class='text-secondary'>（省略聲調符號）</span>的圖案化設計。", desc_inherit:false, tags:"kaohsiung,qishan", tags_inherit:false},
    ...
    {en:"monji-of-khh-yanchao-3-3", md:"燕巢區三號之三", version:"3.3", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Yanchao Dictrict", title_md:"燕巢區", desc:"「燕」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,yanchao", tags_inherit:false},
    {en:"monji-of-khh-yanchen-2-2", md:"鹽埕區二號之二", version:"2.2", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Yanchen Dictrict", title_md:"鹽埕區", desc:"「鹽」的台語羅馬拼音「Iâm」的圖案化設計。", desc_inherit:false, tags:"kaohsiung,yanchen", tags_inherit:false},
    {en:"monji-of-khh-yanchen-3-1", md:"鹽埕區三號之一", version:"3.1", is_main:false, level:2, parent:"monji-of-khh-yanchen-2-2", title_en:"Yanchen Dictrict", title_md:"鹽埕區", desc:"「埕」字的圖案化設計。", desc_inherit:false, tags:"", tags_inherit:true},
    ...
    {en:"monji-of-tainan-city-7-1", md:"台南市七號之一", version:"7.1", is_main:true, level:1, parent:null, title_en:"Tainan City", title_md:"台南市", desc:"紋由外側二重環與內側繩結組成「南」字，代表台南。<br><br>二重環象徵永保與安康；繩結象徵緊繫祝福、天地人美滿和諧。", desc_inherit:false, tags:"tainan", tags_inherit:false},
    ...
    {en:"monji-of-chy-alishan-1-1", md:"阿里山鄉一號之一", version:"1.1", is_main:true, level:2, parent:"monji-of-chiayi-county-3-2", title_en:"Alishan Township", title_md:"阿里山鄉", desc:"「森」字代表阿里山鄉的豐富森林文化。", desc_inherit:false, tags:"chiayi,alishan", tags_inherit:false},
    ...
    {en:"monji-of-pingtung-county-7-2", md:"屏東縣七號之二", version:"7.2", is_main:false, level:2, parent:"monji-of-pingtung-county-7-1", title_en:"Pingtung County", title_md:"屏東縣", desc:"「屏」字的圖案化設計。", desc_inherit:false, tags:"pingtung", tags_inherit:false},
    {en:"monji-of-pingtung-city-1-1", md:"屏東市一號之一", version:"1.1", is_main:true, level:1, parent:"monji-of-pingtung-county-7-1", title_en:"Pingtung City", title_md:"屏東市", desc:"「屏」的注音「ㄆ」的圖案化設計。", desc_inherit:false, tags:"pingtung", tags_inherit:false},
    ...
    {en:"monji-of-pif-jiuru-1-1", md:"九如鄉一號之一", version:"1.1", is_main:true, level:2, parent:"monji-of-pingtung-county-7-1", title_en:"Jiuru County", title_md:"九如鄉", desc:"「九」字的圖案化設計。", desc_inherit:false, tags:"pingtung,jiuru", tags_inherit:false},
    ...
    {en:"monji-of-taichung-city-9-2", md:"台中市九號之二", version:"9.2", is_main:true, level:1, parent:null, title_en:"Taichung City", title_md:"台中市", desc:"「中市」二字的圖案化設計。<br><br>三個方角代表和平、民主與繁榮，中央的圓代表和樂美滿團圓。<br><br>雖然設計了台中市章，但站主認為<a src='/images/monjis/monji-of-taichuu.png' class='modal-trigger-image text-dark'>自大正 10 年就使用至今的台中市章<i class='tbk tbk-taichuu mx-1'></i></a>最為適合台中市。", desc_inherit:false, tags:"taichung", tags_inherit:false},
