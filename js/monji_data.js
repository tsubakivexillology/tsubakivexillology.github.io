var monjiImages = [
    {en:"monji-of-taiwan-2-1", md:"台灣二號之一", version:"2.1", is_main:true, level:1, parent:null, title_en:"Taiwan", title_md:"台灣", desc:"圓形的台字紋象徵台灣人的共和共榮。", desc_inherit:false, tags:"taiwan", tags_inherit:false},
    ...
    {en:"monji-of-kaohsiung-city-4-8-2", md:"高雄市四號之八", version:"4.8.2", is_main:true, level:1, parent:null, title_en:"Kaohsiung City", title_md:"高雄市", desc:"紋結合了「高」字與<a src='/images/monjis/monji-of-takao-city.png' class='modal-trigger-image text-dark'>日本時代的高雄市章</a>，象徵這座城市繼承的歷史與人文。<br><br>紋自上而下可分為三個菱形區塊，分別象徵和平、民主與自由。", desc_inherit:false, tags:"kaohsiung", tags_inherit:false},
    ...
    {en:"monji-of-khh-nanzih-1-1", md:"楠梓區一號之一", version:"1.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Nanzih Dictrict", title_md:"楠梓區", desc:"「楠」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,nanzih", tags_inherit:false},
    {en:"monji-of-khh-neimen-2-1", md:"內門區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Neimen Dictrict", title_md:"內門區", desc:"「內」與「門」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,neimen", tags_inherit:false},
    ...
    {en:"monji-of-tnn-danei-4-1", md:"大內區四號之一", version:"4.1", is_main:true, level:2, parent:"monji-of-tainan-city-7-1", title_en:"Danei Dictrict", title_md:"大內區", desc:"「大」與「內」字的圖案化設計。", desc_inherit:false, tags:"tainan,danei", tags_inherit:false},
    ...
    {en:"monji-of-tnn-shanshang-3-1", md:"山上區三號之一", version:"3.1", is_main:true, level:2, parent:"monji-of-tainan-city-7-1", title_en:"Shanshang Dictrict", title_md:"山上區", desc:"「山」與「上」字的圖案化設計。", desc_inherit:false, tags:"tainan,shanshang", tags_inherit:false},
    ...
    {en:"monji-of-tnn-west-central-2-2", md:"中西區二號之二", version:"2.2", is_main:true, level:2, parent:"monji-of-tainan-city-7-1", title_en:"West Central Dictrict", title_md:"中西區", desc:"「中」與「西」字的圖案化設計。", desc_inherit:false, tags:"tainan,tnn_west_central", tags_inherit:false},
