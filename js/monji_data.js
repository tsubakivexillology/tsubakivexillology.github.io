var monjiImages = [
    ...
    {en:"monji-of-kaohsiung-city-4-8-2", md:"高雄市四號之八", version:"4.8.2", is_main:true, level:1, parent:null, title_en:"Kaohsiung City", title_md:"高雄市", desc:"紋結合了「高」字與<a src='/images/monjis/monji-of-takao-city.png' class='modal-trigger-image text-dark'>日本時代的高雄市章<i class='tbk tbk-takao mx-2'></i></a>，象徵高雄的歷史與人文。<br><br>紋自上而下可分為三個菱形區塊，分別代表和平、民主與自由。", desc_inherit:false, tags:"kaohsiung", tags_inherit:false},
    ...
    {en:"monji-of-khh-gushan-2-1", md:"鼓山區二號之一", version:"2.1", is_main:true, level:2, parent:"monji-of-kaohsiung-city-4-8-2", title_en:"Gushan Dictrict", title_md:"鼓山區", desc:"「山」字的圖案化設計。", desc_inherit:false, tags:"kaohsiung,gushan", tags_inherit:false},
