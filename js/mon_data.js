var monImages = [
	...
	{en:"mon-of-tsubaki", md:"椿", level:1, parent:null, title_en:"Tsubaki", title_md:"椿", desc:"椿花又稱「山茶花」，象徵謙敬溫和、乾淨俐落。", desc_inherit:false, tags:"tsubaki", tags_inherit:false},
	...
	{en:"mon-of-tsubaki-saber", md:"劍氣椿", level:2, parent:"mon-of-tsubaki", title_en:"Saber Tsubaki", title_md:"劍氣椿", desc:"不忘仁愛的代價是武力。", desc_inherit:false, tags:"", tags_inherit:true},
	{en:"mon-of-tsubaki-saber-o", md:"環內劍氣椿", level:2, parent:"mon-of-tsubaki-saber", title_en:"Encircled Saber Tsubaki", title_md:"環內劍氣椿", desc:"", desc_inherit:true, tags:"", tags_inherit:true},
	{en:"mon-of-tsubaki-kumiaikaku", md:"組合角內椿", level:2, parent:"mon-of-tsubaki", title_en:"Ensquared Tsubaki", title_md:"組合角內椿", desc:"八方所在，邪氣都要遠離。", desc_inherit:false, tags:"", tags_inherit:true},
	{en:"mon-of-tsubaki-3split-o", md:"環內三分割椿", level:2, parent:"mon-of-tsubaki", title_en:"Tripartite Tsubakies", title_md:"環內三分割椿", desc:"", desc_inherit:true, tags:"", tags_inherit:true},
	{en:"mon-of-tsubaki-3split-feather-o", md:"環內三分割箭羽椿", level:2, parent:"mon-of-tsubaki", title_en:"Encircled Tripartite Tsubakies And Feathers", title_md:"環內三分割箭羽椿", desc:"不忘仁愛的代價是武力。", desc_inherit:false, tags:"tsubaki,feather", tags_inherit:false},
	...
	{en:"mon-of-tsubaki-holding", md:"抱椿", level:2, parent:"mon-of-tsubaki", title_en:"Holding Tsubaki", title_md:"抱椿", desc:"就像親子團聚一樣，擁抱在一起。", desc_inherit:false, tags:"", tags_inherit:true},
	{en:"mon-of-tsubaki-holding-o", md:"環內抱椿", level:2, parent:"mon-of-tsubaki-holding", title_en:"Encircled Holding Tsubaki", title_md:"環內抱椿", desc:"", desc_inherit:true, tags:"", tags_inherit:true},
	{en:"mon-of-inori-tsubaki", md:"祈椿", level:2, parent:"mon-of-tsubaki", title_en:"Inori Tsubaki", title_md:"祈椿", desc:"椿花象徵謙敬溫和、乾淨俐落。<br><br>兩枝花環抱著中央的椿，代表家庭的祝福。是本站站主的紋章。", desc_inherit:false, tags:"tsubaki", tags_inherit:false},
	...
	{en:"mon-of-kikyo-3fold-sideview-feather", md:"箭羽桔梗", level:1, parent:null, title_en:"Triple Sideview Kikyo And Feathers", title_md:"箭羽桔梗", desc:"不忘仁愛的代價是武力。", desc_inherit:false, tags:"kikyo,feather", tags_inherit:false},
	...
	{en:"mon-of-lily-3split-feather-o", md:"環內三分割箭羽百合", level:2, parent:"mon-of-lily", title_en:"Encircled Tripartite Lilies with Feather", title_md:"環內三分割箭羽百合", desc:"不忘仁愛的代價是武力。", desc_inherit:false, tags:"lily,feather", tags_inherit:false},
	...
	{en:"mon-of-lily-24petal-soft-taiwan", md:"二十四重瓣柔百合內台字", level:2, parent:"mon-of-lily-24petal-soft", title_en:"Taiwan in Twenty-Four-Petaled Soft Lily", title_md:"二十四重瓣柔百合內台字", desc:"台字百合象徵台灣本土精神。", desc_inherit:false, tags:"", tags_inherit:true},
	...
	{en:"mon-of-lily-24petal-soft-kaohsiung", md:"二十四重瓣柔百合內高字", level:2, parent:"mon-of-lily-24petal-soft", title_en:"Kaohsiung in Twenty-Four-Petaled Soft Lily", title_md:"二十四重瓣柔百合內高字", desc:"高字百合代表高雄。", desc_inherit:false, tags:"", tags_inherit:true},
	...
	{en:"mon-of-lily-24petal-soft-tainan", md:"二十四重瓣柔百合內南字", level:2, parent:"mon-of-lily-24petal-soft", title_en:"Tainan in Twenty-Four-Petaled Soft Lily", title_md:"二十四重瓣柔百合內南字", desc:"南字百合代表台南。", desc_inherit:false, tags:"", tags_inherit:true},
	...
	{en:"mon-of-lily-24petal-soft-chiayi", md:"二十四重瓣柔百合內嘉字", level:2, parent:"mon-of-lily-24petal-soft", title_en:"Chiayi in Twenty-Four-Petaled Soft Lily", title_md:"二十四重瓣柔百合內嘉字", desc:"嘉字百合代表嘉義。", desc_inherit:false, tags:"", tags_inherit:true},
	...
	{en:"mon-of-lily-24petal-soft-penghu", md:"二十四重瓣柔百合內澎字", level:2, parent:"mon-of-lily-24petal-soft", title_en:"Penghu in Twenty-Four-Petaled Soft Lily", title_md:"二十四重瓣柔百合內澎字", desc:"澎字百合代表澎湖。", desc_inherit:false, tags:"", tags_inherit:true},
	...
	{en:"mon-of-tai-upon-lily", md:"台字紋", level:1, parent:null, title_en:"Mon of Taiwan", title_md:"台字紋", desc:"台字紋的厚重線條承載著台灣的歷史。", desc_inherit:false, tags:"lily,mon_of_tai", tags_inherit:false},
